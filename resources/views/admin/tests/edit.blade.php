...
@section('title', __('tests.admin.edit_title') . ': ' . $test->title)
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0">{{ __('tests.admin.edit_title') }}</h1>
                    <p class="text-muted small mb-0">{{ $test->title }}</p>
                </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.tests.update', $test) }}" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-check mb-4">
                            ...
                            <input type="checkbox" id="is_published" name="is_published" value="1"
                                   ...
                                   {{ old('is_published', $test->is_published) ? 'checked' : '' }}>
